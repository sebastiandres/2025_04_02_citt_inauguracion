...
::: columns
::: {.column width="50%"}
![](images/dunningkruger.jpeg){fig-align="center" height="500px" width="700px"}
:::
::: {.column width="50%" .incremental}
1. Para aprender necesitas **tiempo** y **esfuerzo**.
...
:::
::: {.column width="50%" .incremental}
1. Aprender proactivamente: Cuéstionandolo todo.
:::
:::

---

## Aprendizajes #3: ¿Y Python?

::: columns
::: {.column width="50%"}
* Usa Python para aprender lo que sea.
:::
::: {.column width="50%"}
![](images/libraries.jpg){fig-align="center" height="600px"}
:::
