...
[ ![](images/potro_salvaje.jpg){fig-align="center" width=100%} ]{.fragment fragment-index=1}
:::
::: {.column width="50%"}
LLMs para uso en producción:

[ ![](images/potro_domado.jpg){fig-align="center" width=100%} ]{.fragment fragment-index=2}
:::
:::
...
Gold Standard es una metodología para evaluar un "algoritmo" cuando:
