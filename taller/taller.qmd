...
* **Actividad**: Ir a [https://platform.openai.com/tokenizer](https://platform.openai.com/tokenizer){target="_blank"}
...
* **Actividad**: Ir a [https://huggingface.co/spaces/alonsosilva/NextTokenPrediction](https://huggingface.co/spaces/alonsosilva/NextTokenPrediction){target="_blank"}
